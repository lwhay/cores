...
public class UnionTest {
    private static void buildTest(String path, Schema s) throws IOException {
        BatchAvroColumnWriter<Record> writer = new BatchAvroColumnWriter<Record>(s, path, 1000, 2000, "snappy");
        ...
        File[] files = new File[tmpFiles.length / 2];
        int i = 0;
